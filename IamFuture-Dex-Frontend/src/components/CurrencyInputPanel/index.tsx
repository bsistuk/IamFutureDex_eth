...
import { Currency, Pair } from '@iamfuture/sdk'
import { Button, ChevronDownIcon, Text, useModal, Flex } from '@iamfuture/uikit'
...
const InputRow = styled.div<{ selected: boolean }>`
  display: flex;
  border-radius: 6px;
  background-image: ${({ theme }) => theme.colors.inputGradient}, ${({ theme }) => theme.colors.inputGradient};
...
const CurrencySelectButton = styled(Button).attrs({ variant: 'text', scale: 'sm' })`
  ...
  height: 44px;
  border-radius: 6px;
  /* background: ${({ theme }) => theme.colors.inputGradientOuter}; */
      ...
      <Container hideInput={hideInput}>
        {!hideInput && (
          <>
            ...
            <LabelAmtRow>
              <RowBetween>
                <Text fontSize="14px">{translatedAmount}</Text>
                {account && (
