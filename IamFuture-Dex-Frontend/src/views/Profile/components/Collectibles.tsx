...
import { Heading, Text, Flex, ChevronRightIcon } from '@iamfuture/uikit'
...
const Collectibles = () => {
  ...
  return (
    <>
      ...
      <Text as="p">
        {t('Pancake Collectibles are special ERC-721 NFTs that can be used on the IamFutureSwap platform.')}
      </Text>
      <Text as="p">
