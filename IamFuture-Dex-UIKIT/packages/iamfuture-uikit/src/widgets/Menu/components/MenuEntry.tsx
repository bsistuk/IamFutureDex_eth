...
const LinkLabel = styled.div<{ isActive: boolean; isPushed: boolean }>`
  /* color: ${({ isActive, theme }) => (isActive ? theme.colors.background : theme.colors.text)}; */
...
const MenuEntry = styled.div<Props>`
  ...
  background-color: ${({ isActive, theme }) => (isActive ? theme.colors.text : theme.colors.background)};
  color: ${({ isActive, theme }) => (isActive ? theme.colors.background : theme.colors.text)};
  a {
    display: flex;
    align-items: center;
  ...
  svg {
    fill: ${({ isActive, theme }) => (isActive ? theme.colors.background : theme.colors.text)};
  }
